...
func init() {
	...
	db_connection := "user=postgres dbname=chicago_business_intelligence password=pogsdata host=/cloudsql/cbiproject2:us-central1:mypostgres sslmode=disable port = 5432"
